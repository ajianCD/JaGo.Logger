...
namespace chdu.jago.logger.Implements
{
    ...
    public abstract class LoggerBase : ILogger
    {
        ...
        public LoggerBase()
        {
            FileUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Logs");
        }
        ...
        public ILogger SetPath(string path)
        {
            ...
            {
                FileUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Logs", path);
            }
            return this;
        }
