...
using System.Text;
using chdu.jago.logger.Implements;
using chdu.jago.logger.ReadConfig;

namespace chdu.jago.logger
{
    /// <summary>
    /// 日志生产类
    ...
    public sealed class LoggerFactory : ILogger
    {
        ...
        private LoggerFactory()
        {
            ...
            if (ConfigManager.Config != null)
                type = ConfigManager.Config.Type.ToLower();
        ...
        /// 日志级别
        /// </summary>
        private static Level level = (Level)Enum.Parse(typeof(Level), (ConfigManager.Config.Level ?? "DEBUG").ToUpper());
        /// <summary>
        /// 线程锁
        /// </summary>
